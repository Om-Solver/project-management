...
const syncUserCreation = inngest.createFunction(
    ...
    async ({ event }) => {
        ...
        await prisma.user.create({
            data: {
                id: data.id,
                email: (data?.email_addresses?.find(e => e.id === data?.primary_email_address_id)?.email_address) ?? data?.email_addresses?.[0]?.email_address,
...
const sendTaskAssignmentEmail = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await sendEmail({
            ...
            <div style="border: 1px solid #ddd; padding: 12px 16p; border-radius: 6px; margin-bottom: 30px;">
